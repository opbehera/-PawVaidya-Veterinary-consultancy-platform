...
const Signup = () => {
  ...
  return (
    <div className="flex min-h-screen border ">
      ...
      {/* Right side - Form */}
      <div className="w-full lg:w-1/2 p-8 flex flex-col justify-center bg-transparent border ">
        <div className="max-w-md mx-auto w-full p-8 bg-[#A8D5BA] rounded-xl">
          ...
          <form onSubmit={onSubmitHandler} className="space-y-5 bg-transparent">
            ...
            <button
              type="submit"
              className="w-full bg-[#489065] text-white py-4 rounded-xl font-semibold hover:bg-[#2e5b40]
                        transition-all duration-300 
                       transform hover:scale-[1.01] active:scale-[0.99] shadow-lg"
            >
              Create Account<span className="text-xl bg-transparent">🦥</span>
            </button>
            ...
            <p className="text-center text-sm text-gray-600 bg-transparent">
              ...
              <a
                ...
                className="text-[#2A9D8F] font-medium hover:text-[#238276] cursor-pointer bg-transparent"
              >
                Login
              </a>
            </p>
